const pages = [
    ...
    {title: "Home", url: "../index.html"},
      ...
      {title: "Dragon scale helmet", url: "../cities/Aberon.html#dcalehelm"},
      ...
      {title: "Drushak's Annihilator", url: "../cities/drushak.html#dhq"},
      ...
      {title: "Right horn piece for HOTA", url: "../cities/drushak.html#rhota"},
      ...
      {title: "Hitchhiker scopes", url: "../cities/other/scopes.html"}
   ];
